...
export default function EnhancedHero() {
  ...
  // Example: handle showing video modal (if you want to implement it)
      ...
      <div className="relative z-10 text-center text-white px-4 md:px-6 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          ...
          <Button
            ...
            className="bg-white border-blue-600 text-blue-700 hover:bg-blue-600 hover:text-white px-8 py-4 text-lg font-semibold rounded-lg shadow transition-all duration-300"
          >
